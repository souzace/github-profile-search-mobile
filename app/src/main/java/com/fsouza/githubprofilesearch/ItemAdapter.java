package com.fsouza.githubprofilesearch;
...
import com.fsouza.githubprofilesearch.controller.DetailActivity;
            ...
            itemView.setOnClickListener(new View.OnClickListener(){
                ...
                public void onClick(View v){
                    ...
                    if (pos != RecyclerView.NO_POSITION){
                        ...
                        intent.putExtra("avatar_url", items.get(pos).getAvarUrl());
